...
export default function AccessPage() {
  ...
  const workspaceRoles = useQuery({ queryKey: queryKeys.workspaceRoles(workspaceId), queryFn: () => api.workspaceRoles(workspaceId as string), enabled: Boolean(workspaceId) });
