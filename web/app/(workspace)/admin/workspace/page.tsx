...
export default function WorkspaceSettingsPage() {
  ...
  const deleteMutation = useMutation({ mutationFn: () => controlApi.deleteWorkspace(workspaceId), onSuccess: () => { toast.success("工作区已删除"); router.replace("/login"); }, onError: (error) => toast.error(error.message) });
