...
export default function WorkspaceSettingsPage() {
  ...
  return <AdminPageFrame requiredPermission="manage_tenant"><PageHeader eyebrow="Workspace boundary" title="工作区设置" description="管理工作区名称、创建新的数据边界，或执行受确认保护的删除。" />{!workspace ? <EmptyState icon={Building2} title="本地兼容工作区" description="本地模式使用后端默认租户，不提供账号级工作区创建和删除。" /> : <div className="mx-auto max-w-3xl space-y-6 p-4 md:p-6">
